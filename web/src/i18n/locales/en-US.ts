export default {
    ...
    settingsPanels: {
        ...
        image: { title: "Image settings", quality: "Quality", size: "Size", align16: "Align to multiples of 16", align16Hint: "Round dimensions up to the next multiple of 16 after input", aspectRatio: "Aspect ratio", transparent: "Transparent background", transparentHint: "Generate an image without a background when supported by the model", count: "Image count", images: "{{count}} images", outputTier: "Output tier", dispatchMode: "Request mode", dispatchModes: { sync: "Synchronous", async: "Asynchronous", syncHint: "Use the standard OpenAI Images request flow", asyncHint: "Create a task and poll for long-running image generation" }, concurrency: "Concurrency" },
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", referenceMode: "Reference image mode", referenceModes: { auto: "Standard references", frames: "First and last frames" }, sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    imageWorkbench: {
        ...
        persistenceFailed: "The image was generated and can be previewed, but saving it in the browser failed and it may be lost after refresh",
    ...
    canvas: {
        ...
        generation: { interrupted: "Generation was interrupted by a page refresh. Generate again.", videoPollingPaused: "Polling paused after the page refresh. Retry to continue the original task without creating or charging for another task.", front: "front view", rotateRight: "rotated {{angle}} degrees right", rotateLeft: "rotated {{angle}} degrees left", level: "eye-level view", topDown: "{{angle}}-degree top-down view", lowAngle: "{{angle}}-degree low-angle view", angleLabel: "AI multi-angle: {{horizontal}}, {{pitch}}, camera distance {{distance}}, {{lens}} lens", anglePrompt: "Regenerate a new view of the same subject from the reference image. Preserve the subject, colors, materials, and visual style; do not merely apply perspective distortion. {{angle}}." },
