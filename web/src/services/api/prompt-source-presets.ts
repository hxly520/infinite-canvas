...
export const XIAN_YU_PROMPT_SOURCE_ID = "xianyu-gptimage2-latest";
...
export const DEFAULT_PROMPT_SOURCES: PromptSource[] = [
    ...
    { id: XIAN_YU_PROMPT_SOURCE_ID, name: "Xianyu GPT Image 2", url: "https://raw.githubusercontent.com/xianyu110/awesome-gptimage2/main/data/latest-prompts.json", homepage: "https://github.com/xianyu110/awesome-gptimage2", enabled: true, builtIn: true },
];
