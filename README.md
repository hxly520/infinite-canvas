...
- AI 创作：浏览器前台直连你配置的 OpenAI 兼容接口，支持文生图、图生图、参考图编辑、文本问答、音频和视频生成；52Token 分支适配统一视频任务 API 和多参考素材。
...
- [Sub2API 适配与二开维护](docs/content/docs/backend/sub2api-integration.mdx)
